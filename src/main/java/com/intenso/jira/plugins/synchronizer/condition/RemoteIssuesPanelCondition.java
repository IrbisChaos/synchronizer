...
public class RemoteIssuesPanelCondition extends AbstractWebCondition
{
    public boolean shouldDisplay(final ApplicationUser user, final JiraHelper jiraHelper) {
        ...
        if (config != null && config.getGenRemoteIssuePanel() != null && config.getGenRemoteIssuePanel().equals(0)) {
            return false;
        }
